				...
				<div id="first">
					<div class="myform form ">
						...
						<form action="" method="post" name="login">
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Password Check</label> <input
									type="password" name="password" id="password"
									class="form-control" aria-describedby="emailHelp"
									placeholder="Enter Password">
							</div>
							...
							<div class="form-group">
								<p class="text-center">By signing up, you automatically
							...
							<div class="col-md-12 mb-3">
								<p class="text-center">
									<a href="javascript:void();" class="google btn mybtn"><i
										class="fa fa-google-plus"> </i> Google SignUp </a>
								</p>
							</div>
							<div class="form-group">
								<p class="text-center">
									Do you have an account? Please<a href="/book" id="signup">SignIn</a>
								</p>
							</div>
						</form>
					</div>
